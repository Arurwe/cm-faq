...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = [
            ...
            ['name' => 'Oprogramowanie', 'order' => '4' ,'background_image' => '/images/categoryBG/program.jpg'],
            ['name' => 'Praca Zdalna', 'order' => '6' ,'background_image' => '/images/categoryBG/zdalna.jpg'],
            ...
            ['name' => 'Komputery służbowe', 'order' => '9' ,'background_image' => '/images/categoryBG/ws-tech2.jpg'],
            ['name' => 'Wsparcie techniczne', 'order' => '8' ,'background_image' => '/images/categoryBG/ws-tech.png'],
            ['name' => 'EZD', 'order' => '3' ,'background_image' => '/images/categoryBG/ws-tech.png'],
        ];
